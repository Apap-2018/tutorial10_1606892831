...
import { UpdateStaffFarmasi } from './screens/UpdateStaffFarmasi';
				...
				<div className="App">
					...
					<div className="container">
						<Switch>
							...
							<Route path="/update-staff/:id" exact component={UpdateStaffFarmasi}/>
							<Route path="/addLabResult" exact component={AddLabResult}/>
